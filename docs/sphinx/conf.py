...
from sdss_apogee import __version__
...
project = 'sdss_apogee'
copyright = '{0}, {1}'.format('2017', 'David Nidever')
...
htmlhelp_basename = '{0}pdoc'.format('sdss_apogee')
...
man_pages = [
    (master_doc, 'sdss_apogee', u'{0} Documentation'.format(project),
     [author], 1)
]
